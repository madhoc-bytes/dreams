...
def dm_create_v1(token, u_ids):
    ...
    ownwer_infomation = {}
    ownwer_infomation['u_id'] = owner_details['u_id']
    ownwer_infomation['hanname_firstdle'] = owner_details['name_first']
    ownwer_infomation['name_last'] = owner_details['name_last']
    details = {}
    ...
    dms.append(
        {
            ...
            'dm_name': dm_name,
            'all_members': members,
            'owner_members': ownwer_infomation,
            'messages': []
        }
    )
